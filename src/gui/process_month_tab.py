"""
Process Month tab - Import Excel files and calculate fair share split.
"""
...
from PyQt5.QtWidgets import (
    ...
    QButtonGroup, QFileDialog, QTextEdit, QScrollArea,
...
class ProcessMonthTab(QWidget):
    """Tab for processing monthly finances."""
    ...
    def init_ui(self):
        ...
        # Title
        title = QLabel("Process Monthly Finances")
        title_font = QFont()
    ...
    def calculate_split(self):
        ...
        self.person1_btn.setEnabled(False)
        self.person2_btn.setEnabled(False)
    ...
    def on_calculation_finished(self, result, error):
        ...
        self.person1_btn.setEnabled(True)
        self.person2_btn.setEnabled(True)
